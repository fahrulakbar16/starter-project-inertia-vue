    ...
    >
        ...
        >
            ...
            >
                <div
                    v-show="show"
                    class="mb-6 bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all w-full mx-auto"
                    :class="maxWidthClass"
                >
                    <!-- Header -->
                    <div
                    ...
                    <!-- Body -->
                    <div
                        class="px-8 py-4 max-h-[400px] overflow-y-auto"
                        data-simplebar
                    >
                        <slot />
                    </div>
